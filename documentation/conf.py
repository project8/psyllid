...
os.environ['PROJECT_NAME'] = 'Psyllid'
os.environ['PROJECT_NUMBER'] = this_version
os.environ['PROJECT_BRIEF_DESC'] = 'Project 8 Data Acquisisition Software'
...
os.environ['PREPROC_INCLUDE_PATH'] = '../midge/scarab/library/utility ../midge/scarab/library/logger'

# Doxygen
call(['doxygen', '../midge/scarab/documentation/cpp/Doxyfile'])
...
project = u'Psyllid'
copyright = u'2018, Psyllid Authors'
...
latex_documents = [
  (master_doc, 'Psyllid.tex', u'Psyllid Documentation',
...
man_pages = [
    (master_doc, 'psyllid', u'Psyllid Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'Psyllid', 'Psyllid Documentation',
   author, 'Psyllid', 'Project 8 Data Acquisition Software',
   'Miscellaneous'),
]
